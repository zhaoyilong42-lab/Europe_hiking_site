    ...
    <div className="fixed inset-0 overflow-y-auto bg-stone-50 z-[100] animate-fade-in flex flex-col" id="route-detail-full-view">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-stone-200/80 px-4 py-3 sm:py-4 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-2 no-print">
          <button onClick={downloadPdf} className="hidden sm:inline-flex items-center gap-1.5 rounded-lg border border-emerald-700 bg-white px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-50" id="btn-export-route-pdf"><Download className="h-4 w-4" /> 导出 PDF</button>
      ...
      <div className="bg-white border-b border-stone-200/60 py-3.5 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto flex flex-wrap gap-2 items-center text-xs">
          ...
          <button onClick={downloadPdf} className="sm:hidden ml-auto inline-flex items-center gap-1 rounded-md border border-emerald-700 px-2.5 py-1.5 font-bold text-emerald-800 no-print"><Download className="h-3.5 w-3.5" /> PDF</button>
        </div>
      </div>
